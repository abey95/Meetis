//
//  NoteRecordingViewController.swift
//  Meetis
//
//  Created by CS3714 on 4/20/18.
...
class NoteRecordingViewController: UIViewController {

    @IBOutlet var pressPlayLabel: UILabel!
    ...
    func startRecording() {
        ...
        transcriptionTextView.text = "Say something, I'm listening!"
