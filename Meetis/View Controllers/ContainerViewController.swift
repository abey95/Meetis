...
class ContainerViewController: UIViewController, HomeTableViewControllerDelegate, UIGestureRecognizerDelegate {
    ...
    func addMenuViewController() {
        ...
        if (menuViewController == nil) {
            ...
            menuViewController!.delegate = homeViewController as? MenuViewControllerDelegate
